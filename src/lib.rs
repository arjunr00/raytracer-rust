...
/// Creates a String containing a PPM representation of an image generated by sending rays to
/// each pixel
pub fn create_ppm(width: u32, height: u32, max_colors: u32) -> String {
    let aspect_ratio = f64::from(width / height);
    let vp_y_max = 1.0;
    ...
    for i in 0..height {
        for j in 0..width {
            ...
            ppm.push_str(&write_pixel(&r.get_color()));
